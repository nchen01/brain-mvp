...
3. **Processors**
   ...
   - **Other formats**: MarkItDown (https://github.com/microsoft/markitdown)
   - **Advanced processing**: Docling (https://github.com/docling-project/docling)

4. **Document Post-Processing Router**
